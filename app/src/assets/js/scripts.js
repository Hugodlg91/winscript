document.addEventListener("DOMContentLoaded", function () {
  ...
  const scripts = {
    microsoftstore: [
      `Write-Host '${window.t("-- Uninstalling Microsoft Store")}' -ForegroundColor Green`,
      'Get-AppxPackage "*Microsoft.WindowsStore*" | Remove-AppxPackage',
    ],
    msstoreupdates: [
      `Write-Host '${window.t("-- Disabling Microsoft Store App Updates")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\WindowsStore" /v "AutoDownload" /t REG_DWORD /d 2 /f',
    ],
    onedrive: [
      `Write-Host '${window.t("-- Uninstalling OneDrive")}' -ForegroundColor Green`,
      ...
      "}",
      `Write-Host '${window.t("-- Copying OneDrive files to local folders")}'`,
      'robocopy "$env:USERPROFILE\\OneDrive" "$env:USERPROFILE" /mov /e /xj /ndl /nfl /njh /njs /nc /ns /np | Out-Null',
      `Write-Host '${window.t("-- Removing OneDrive from explorer sidebar")}'`,
      ...
      `Write-Host '${window.t("-- Removing shortcut entry")}'`,
      'Remove-Item "$env:APPDATA\\Microsoft\\Windows\\Start Menu\\Programs\\OneDrive.lnk" -Force',
      `Write-Host '${window.t("-- Removing scheduled task")}'`,
      ...
      `Write-Host '${window.t("-- Removing OneDrive leftovers")}'`,
    ...
    debloatedge: [
      `Write-Host '${window.t("-- Debloating Edge")}' -ForegroundColor Green`,
    ...
    edge: [
      `Write-Host '${window.t("-- Uninstalling Edge")}' -ForegroundColor Green`,
    ...
    copilot: [
      `Write-Host '${window.t("-- Removing Copilot")}' -ForegroundColor Green`,
    ...
    widgets: [
      `Write-Host '${window.t("-- Uninstalling Widgets")}' -ForegroundColor Green`,
    ...
    thirdparty: [
      `Write-Host '${window.t("-- Uninstalling third-party apps")}' -ForegroundColor Green`,
    ...
    extensions: [
      `Write-Host '${window.t("-- Uninstalling extensions")}' -ForegroundColor Green`,
    ...
    msapps: [
      `Write-Host '${window.t("-- Uninstalling Microsoft apps")}' -ForegroundColor Green`,
    ...
    xbox: [
      `Write-Host '${window.t("-- Uninstalling Xbox")}' -ForegroundColor Green`,
    ...
    consumerfeatures: [
      `Write-Host '${window.t("-- Disabling Consumer Features")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\CloudContent" /v "DisableWindowsConsumerFeatures" /t "REG_DWORD" /d "1" /f',
    ],
    recall: [
      `Write-Host '${window.t("-- Disabling Recall")}' -ForegroundColor Green`,
    ...
    notepadrewrite: [
      `Write-Host '${window.t("-- Removing AI from Copilot")}' -ForegroundColor Green`,
    ...
    aiappxpackages: [
      `Write-Host '${window.t("-- Removing AI AppX Packages")}' -ForegroundColor Green`,
    ...
    hideai: [
      `Write-Host '${window.t("-- Hiding Copilot Button in Explorer")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced" /v "ShowCopilotButton" /t REG_DWORD /d 0 /f',
    ],
    aifiles: [
      `Write-Host '${window.t("-- Removing AI Files")}' -ForegroundColor Green`,
    ...
    iexplorer: [
      `Write-Host '${window.t("-- Disabling Internet Explorer")}' -ForegroundColor Green`,
    ...
    hyperv: [
      `Write-Host '${window.t("-- Disabling Hyper-V")}' -ForegroundColor Green`,
    ...
    faxscan: [
      `Write-Host '${window.t("-- Disabling Fax and Scan")}' -ForegroundColor Green`,
    ...
    mediaplayer: [
      `Write-Host '${window.t("-- Disabling Windows Media Player")}' -ForegroundColor Green`,
    ...
    wsearch: [
      `Write-Host '${window.t("-- Disabling Windows Search")}' -ForegroundColor Green`,
      'Stop-Service -Name "wsearch"',
      'Set-Service -Name "wsearch" -StartupType Disabled',
    ],
    wtelemetry: [
      `Write-Host '${window.t("-- Disabling Windows Telemetry")}' -ForegroundColor Green`,
    ...
    wupdate: [
      `Write-Host '${window.t("-- Disabling Windows Update Telemetry")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\DriverSearching" /v "SearchOrderConfig" /t REG_DWORD /d 0 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\DeliveryOptimization" /v "DODownloadMode" /t "REG_DWORD" /d 0 /f',
    ],
    wsearchtelemetry: [
      `Write-Host '${window.t("-- Disabling Windows Search Telemetry")}' -ForegroundColor Green`,
    ...
    officetelemetry: [
      `Write-Host '${window.t("-- Disabling Office telemetry")}' -ForegroundColor Green`,
    ...
    appexperience: [
      `Write-Host '${window.t("-- Disabling Application Experience telemetry")}' -ForegroundColor Green`,
    ...
    windowsdrm: [
      `Write-Host '${window.t("-- Disabling Internet Access to Windows DRM")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\WMDRM" /v "DisableOnline" /t REG_DWORD /d 1 /f',
    ],
    cloudbasedspeech: [
      `Write-Host '${window.t("-- Disabling Cloud Based Speech Recognition")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Microsoft\\Speech_OneCore\\Settings\\OnlineSpeechPrivacy" /v "HasAccepted" /t REG_DWORD /d 0 /f',
    ],
    wfeedback: [
      `Write-Host '${window.t("-- Disabling Windows Feedback Experience telemetry")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Siuf\\Rules" /v "NumberOfSIUFInPeriod" /t REG_DWORD /d 0 /f',
      'reg add "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\DataCollection" /v "DoNotShowFeedbackNotifications" /t REG_DWORD /d 1 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection" /v "DoNotShowFeedbackNotifications" /t REG_DWORD /d 1 /f',
    ],
    handwriting: [
      `Write-Host '${window.t("-- Disabling Handwriting telemetry")}' -ForegroundColor Green`,
    ...
    clipboard: [
      `Write-Host '${window.t("-- Disabling Clipboard history and Cloud Clipboard")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Policies\\Microsoft\\InputPersonalization" /v "RestrictImplicitInkCollection" /t REG_DWORD /d 1 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\InputPersonalization" /v "RestrictImplicitInkCollection" /t REG_DWORD /d 1 /f',
      'reg add "HKCU\\Software\\Policies\\Microsoft\\InputPersonalization" /v "RestrictImplicitTextCollection" /t REG_DWORD /d 1 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\InputPersonalization" /v "RestrictImplicitTextCollection" /t REG_DWORD /d 1 /f',
    ...
    targetads: [
      `Write-Host '${window.t("-- Disabling Targeted Ads and Data Collection")}' -ForegroundColor Green`,
    ...
    privacyonsent: [
      `Write-Host '${window.t("-- Opting out of data collection")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Personalization\\Settings" /v "AcceptedPrivacyPolicy" /t REG_DWORD /d 0 /f',
    ],
    adobetelemetry: [
      `Write-Host '${window.t("-- Disabling Adobe Telemetry")}' -ForegroundColor Green`,
      "try {",
    ...
    nvidiatelemetry: [
      `Write-Host '${window.t("-- Disabling NVIDIA telemetry")}' -ForegroundColor Green`,
    ...
    vscodetelemetry: [
      `Write-Host '${window.t("-- Disabling Visual Studio telemetry")}' -ForegroundColor Green`,
    ...
    mediatelemetry: [
      `Write-Host '${window.t("-- Disabling Media Player telemetry")}' -ForegroundColor Green`,
    ...
    powershelltelemetry: [
      `Write-Host '${window.t("-- Disabling PowerShell telemetry")}' -ForegroundColor Green`,
      "setx POWERSHELL_TELEMETRY_OPTOUT 1",
    ],
    privacyconsent: [
      `Write-Host '${window.t("-- Opting out of privacy consent")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Personalization\\Settings" /v "AcceptedPrivacyPolicy" /t REG_DWORD /d 0 /f',
    ],
    ccleanertelemetry: [
      `Write-Host '${window.t("-- Disabling CCleaner telemetry")}' -ForegroundColor Green`,
    ...
    adobeupdates: [
      `Write-Host '${window.t("-- Disabling Adobe updates")}' -ForegroundColor Green`,
    ...
    defaultupdate: [
      `Write-Host '${window.t("-- Restoring default Windows Update settings")}' -ForegroundColor Green`,
      ...
      `Write-Host '${window.t("-- Re-enabling WU services")}'`,
    ...
    securityupdate: [
      `Write-Host '${window.t("-- Delaying feature updates by 1 year")}' -ForegroundColor Green`,
    ...
    disableupdate: [
      `Write-Host '${window.t("-- Disabling Windows Update")}' -ForegroundColor Green`,
      ...
      `Write-Host '${window.t("-- Disabling Windows Update Services")}'`,
    ...
    microphoneaccess: [
      `Write-Host '${window.t("-- Disabling Microphone access")}' -ForegroundColor Green`,
    ...
    systemaccess: [
      `Write-Host '${window.t("-- Disabling System files access")}' -ForegroundColor Green`,
    ...
    accinfoaccess: [
      `Write-Host '${window.t("-- Disabling Account Information access")}' -ForegroundColor Green`,
    ...
    contactsaccess: [
      `Write-Host '${window.t("-- Disabling Contacts access")}' -ForegroundColor Green`,
    ...
    callhistoryaccess: [
      `Write-Host '${window.t("-- Disabling Call History access")}' -ForegroundColor Green`,
    ...
    messagingaccess: [
      `Write-Host '${window.t("-- Disabling Messaging access")}' -ForegroundColor Green`,
    ...
    notificationaccess: [
      `Write-Host '${window.t("-- Disabling Notification access")}' -ForegroundColor Green`,
    ...
    emailaccess: [
      `Write-Host '${window.t("-- Disabling Email access")}' -ForegroundColor Green`,
    ...
    tasksaccess: [
      `Write-Host '${window.t("-- Disabling Tasks access")}' -ForegroundColor Green`,
    ...
    diagaccess: [
      `Write-Host '${window.t("-- Disabling Diagnostics access")}' -ForegroundColor Green`,
    ...
    voiceactivationaccess: [
      `Write-Host '${window.t("-- Disabling Voice Activation access")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Microsoft\\Speech_OneCore\\Settings\\VoiceActivation\\UserPreferenceForAllApps" /v "AgentActivationEnabled" /t REG_DWORD /d 0 /f',
    ],
    phoneaccess: [
      `Write-Host '${window.t("-- Disabling Phone access")}' -ForegroundColor Green`,
    ...
    trustedaccess: [
      `Write-Host '${window.t("-- Disabling Trusted Devices access")}' -ForegroundColor Green`,
    ...
    calendaraccess: [
      `Write-Host '${window.t("-- Disabling Calendar access")}' -ForegroundColor Green`,
    ...
    motionaccess: [
      `Write-Host '${window.t("-- Disabling Motion access")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\CapabilityAccessManager\\ConsentStore\\activity" /v "Value" /d "Deny" /f',
    ],
    radioaccess: [
      `Write-Host '${window.t("-- Disabling Radio access")}' -ForegroundColor Green`,
    ...
    screenshotborderaccess: [
      `Write-Host '${window.t("-- Disabling Screenshot Borders access")}' -ForegroundColor Green`,
    ...
    recordingsaccess: [
      `Write-Host '${window.t("-- Disabling Recordings access")}' -ForegroundColor Green`,
    ...
    aigenerationaccess: [
      `Write-Host '${window.t("-- Disabling AI Generation access")}' -ForegroundColor Green`,
    ...
    updatepause: [
      `Write-Host '${window.t("-- Extend Windows Update Pause Limit to 20 years")}' -ForegroundColor Green`,
      `Write-Host '${window.t("-- NOTE: This does not disable updates by itself, user needs to pause updates in Windows Settings.")}' -ForegroundColor Yellow`,
      'reg add "HKLM\\SOFTWARE\\Microsoft\\WindowsUpdate\\UX\\Settings" /v "FlightSettingsMaxPauseDays" /t REG_DWORD /d 7300 /f',
    ],
    cloudsync: [
      `Write-Host '${window.t("-- Disabling Cloud Sync")}' -ForegroundColor Green`,
    ...
    activityfeed: [
      `Write-Host '${window.t("-- Disabling Activity Feed")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\System" /v "EnableActivityFeed" /d "0" /t REG_DWORD /f',
    ],
    notificationtray: [
      `Write-Host '${window.t("-- Disabling Notification Tray")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Policies\\Microsoft\\Windows\\Explorer" /v "DisableNotificationCenter" /d "1" /t REG_DWORD /f',
    ],
    screenrecording: [
      `Write-Host '${window.t("-- Disabling Xbox Screen Recording")}' -ForegroundColor Green`,
      'reg add "HKCU\\System\\GameConfigStore" /v "GameDVR_Enabled" /t REG_DWORD /d 0 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\GameDVR" /v "AllowGameDVR" /t REG_DWORD /d 0 /f',
    ],
    automap: [
      `Write-Host '${window.t("-- Disabling Auto Map Downloads")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\Maps" /v "AllowUntriggeredNetworkTrafficOnSettingsPage" /t REG_DWORD /d 0 /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\Maps" /v "AutoDownloadAndUpdateMapData" /t REG_DWORD /d 0 /f',
    ],
    default0user: [
      `Write-Host '${window.t("-- Deleting Default0 User")}' -ForegroundColor Green`,
      'Remove-LocalUser -Name "defaultuser0"',
    ],
    lockscreencamera: [
      `Write-Host '${window.t("-- Disabling Lock Screen Camera")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\Personalization" /v "NoLockScreenCamera" /t REG_DWORD /d 1 /f',
    ],
    biometrics: [
      `Write-Host '${window.t("-- Disabling Biometrics (Breaks Windows Hello)")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Biometrics" /v "Enabled" /t REG_DWORD /d "0" /f',
      'reg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Biometrics\\Credential Provider" /v "Enabled" /t "REG_DWORD" /d "0" /f',
    ],

    googledns: [
      `Write-Host '${window.t("-- Setting Google DNS")}' -ForegroundColor Green`,
    ...
    cloudflaredns: [
      `Write-Host '${window.t("-- Setting Cloudflare DNS")}' -ForegroundColor Green`,
    ...
    quad9dns: [
      `Write-Host '${window.t("-- Setting Quad9 DNS")}' -ForegroundColor Green`,
    ...
    opendns: [
      `Write-Host '${window.t("-- Setting OpenDNS DNS")}' -ForegroundColor Green`,
    ...
    adguard: [
      `Write-Host '${window.t("-- Setting AdGuard DNS")}' -ForegroundColor Green`,
    ...
    cleantemp: [
      `Write-Host '${window.t("-- Deleting Temp files")}' -ForegroundColor Green`,
      'Remove-Item -Path "C:\\Windows\\Temp\\*" -Recurse -Force',
      'Remove-Item -Path "C:\\Windows\\Prefetch\\*" -Recurse -Force',
    ],
    cleanmgr: [
      `Write-Host '${window.t("-- Running Disk Clean-up")}' -ForegroundColor Green`,
      "cleanmgr /verylowdisk /sagerun:5",
    ],
    emptyrecycle: [
      `Write-Host '${window.t("-- Emptying Recycle Bin")}' -ForegroundColor Green`,
    ...
    browserhistory: [
      `Write-Host '${window.t("-- Clearing Browser History")}' -ForegroundColor Green`,
    ...
    sfc: [`Write-Host '${window.t("-- Running SFC")}' -ForegroundColor Green`, "sfc /scannow"],
    dism: [
      `Write-Host '${window.t("-- Running DISM")}' -ForegroundColor Green`,
      "DISM /Online /Cleanup-Image /RestoreHealth",
    ],
    resetnetwork: [
      `Write-Host '${window.t("-- Resetting Network")}' -ForegroundColor Green`,
      "ipconfig /flushdns",
      "ipconfig /release | Out-Null",
      "ipconfig /renew | Out-Null",
    ],
    balanced: [
      `Write-Host '${window.t("-- Set Balanced Power Plan")}' -ForegroundColor Green`,
    ...
    highperformance: [
      `Write-Host '${window.t("-- Set High Performance Power Plan")}' -ForegroundColor Green`,
    ...
    ultimateperformance: [
      `Write-Host '${window.t("-- Set Ultimate Performance Power Plan")}' -ForegroundColor Green`,
    ...
    transparency: [
      `Write-Host '${window.t("-- Disabling Transparency")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize" /v "EnableTransparency" /t REG_DWORD /d 0 /f',
    ],
    manualservices: [
      `Write-Host '${window.t("-- Disabling Manual Services")}' -ForegroundColor Green`,
    ...
    mousedelay: [
      `Write-Host '${window.t("-- Disabling Mouse Delay Times")}' -ForegroundColor Green`,
      'reg add "HKCU\\Control Panel\\Desktop" /v "MenuShowDelay" /t REG_SZ /d 0 /f',
      'reg add "HKCU\\Control Panel\\Mouse" /v "MouseHoverTime" /t REG_SZ /d 0 /f',
    ],
    hags: [
      `Write-Host '${window.t("-- Disabling HAGS")}' -ForegroundColor Green`,
      'reg add "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers" /v "HwSchMode" /t REG_DWORD /d 1 /f',
    ],
    storagesense: [
      `Write-Host '${window.t("-- Disabling Storage Sense")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\StorageSense\\Parameters\\StoragePolicy" /v "01" /t REG_DWORD /d 0 /f',
    ],
    disablehibernation: [
      `Write-Host '${window.t("-- Disabling Hibernation")}' -ForegroundColor Green`,
      "powercfg /h off",
    ],
    limitdefender: [
      `Write-Host '${window.t("-- Limiting Windows Defender Usage")}' -ForegroundColor Green`,
    ...
    coreisolation: [
      `Write-Host '${window.t("-- Disabling Core Isolation")}' -ForegroundColor Green`,
      'reg add "HKLM\\System\\CurrentControlSet\\Control\\DeviceGuard\\Scenarios\\HypervisorEnforcedCodeIntegrity" /v "Enabled" /t REG_DWORD /d 0 /f',
    ],
    disableprefetch: [
      `Write-Host '${window.t("-- Disabling Prefetch")}' -ForegroundColor Green`,
      'Stop-Service -Name "sysmain"',
      'Set-Service -Name "sysmain" -StartupType Disabled',
    ],
    darkmode: [
      `Write-Host '${window.t("-- Enabling Dark Mode")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize" /v "AppsUseLightTheme" /t REG_DWORD /d 0 /f',
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize" /v "SystemUsesLightTheme" /t REG_DWORD /d 0 /f',
    ],
    filextensions: [
      `Write-Host '${window.t("-- Showing File Extensions")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced" /v "HideFileExt" /t REG_DWORD /d 0 /f',
    ],
    fullscreenoptimizations: [
      `Write-Host '${window.t("-- Disabling Fullscreen Optimizations")}' -ForegroundColor Green`,
      'reg add "HKCU\\System\\GameConfigStore" /v "GameDVR_DXGIHonorFSEWindowsCompatible" /t REG_DWORD /d 1 /f',
    ],
    mouseacc: [
      `Write-Host '${window.t("-- Disabling Mouse Acceleration")}' -ForegroundColor Green`,
      'reg add "HKCU\\Control Panel\\Mouse" /v "MouseSpeed" /t REG_SZ /d "0" /f',
      'reg add "HKCU\\Control Panel\\Mouse" /v "MouseThreshold1" /t REG_SZ /d "0" /f',
      'reg add "HKCU\\Control Panel\\Mouse" /v "MouseThreshold2" /t REG_SZ /d "0" /f',
    ],
    gamemode: [
      `Write-Host '${window.t("-- Disabling Game Mode")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\GameDVR" /v "AutoGameModeEnabled" /t REG_DWORD /d 0 /f',
      'reg add "HKCU\\SOFTWARE\\Microsoft\\GameBar" /v "AutoGameModeEnabled" /t REG_DWORD /d 0 /f',
    ],
    gamebar: [
      `Write-Host '${window.t("-- Disabling Game Bar")}' -ForegroundColor Green`,
    ...
    classicmenu: [
      `Write-Host '${window.t("-- Setting Classic Right-Click Menu")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Classes\\CLSID\\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\\InprocServer32" /f /ve',
    ],
    endtask: [
      `Write-Host '${window.t("-- Adding End Task to Right-Click")}' -ForegroundColor Green`,
      'reg add "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced\\TaskbarDeveloperSettings" /v "TaskbarEndTask" /t REG_DWORD /d "1" /f',
    ],
    mpo: [
      `Write-Host '${window.t("-- Disabling Multiplane Overlay (MPO)")}' -ForegroundColor Green`,
      'reg add "HKLM\\SOFTWARE\\Microsoft\\Windows\\Dwm" /v "OverlayTestMode" /t REG_DWORD /d "00000005" /f',
    ],
    taskbarleft: [
      `Write-Host '${window.t("-- Moving Taskbar Icons to the left")}' -ForegroundColor Green`,
      'reg add "HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced" /v TaskbarAl /t REG_DWORD /d 0 /f',
    ],
    stickykeys: [
      `Write-Host '${window.t("-- Disabling Sticky Keys")}' -ForegroundColor Green`,
      'reg add "HKCU\\Control Panel\\Accessibility\\StickyKeys" /v "Flags" /t REG_SZ /d "58" /f',
    ],
    taskbarwidgets: [
      `Write-Host '${window.t("-- Disabling Taskbar Widgets")}' -ForegroundColor Green`,
    ...
    numlockstartup: [
      `Write-Host '${window.t("-- Disabling Num Lock on Startup")}' -ForegroundColor Green`,
      'reg add "HKCU\\Control Panel\\Keyboard" /v "InitialKeyboardIndicators" /t REG_SZ /d "0" /f',
    ],
    snapflyout: [
      `Write-Host '${window.t("-- Disabling Snap Assist Flyout")}' -ForegroundColor Green`,
      'reg add "HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced" /v "EnableSnapAssistFlyout" /t REG_DWORD /d 0 /f',
    ],
    detailedbsod: [
      `Write-Host '${window.t("-- Enabling Detailed BSOD")}' -ForegroundColor Green`,
      'reg add "HKLM\\System\\CurrentControlSet\\Control\\CrashControl" /v "DisplayParameters" /t REG_DWORD /d 1 /f',
    ],
    verboselogon: [
      `Write-Host '${window.t("-- Enabling Verbose Logon")}' -ForegroundColor Green`,
